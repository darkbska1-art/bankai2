...
async function handleMemberRemove(member) {
    ...
    try {
        ...
        // Üyenin hangi davetle geldiği kayıtlıysa
        // davet eden kişinin geçerli sayısını düşür
        if (inviteInfo) {
            ...
            console.log(
                `📤 ${member.user.tag} ayrıldı. Davet istatistiği güncellendi.`
            );
        }
